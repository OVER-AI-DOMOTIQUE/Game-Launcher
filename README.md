...
👉 [**setup.exe**]([https://github.com/OVER-AI-DOMOTIQUE/Game-Launcher/releases/download/V1.0/setup.exe](https://github.com/OVER-AI-DOMOTIQUE/Game-Launcher/releases/download/Game-Launcher/setup.exe)
